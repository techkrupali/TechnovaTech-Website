...
const projects: Project[] = [
  {
    ...
    category: "SaaS & ERP",
    about:
      "Our flagship point-of-sale platform, trusted daily by thousands of retail stores across India — billing, stock and customers handled from one fast screen, even when the internet drops.",
    features: [
      "Bill in seconds, even offline",
      "Barcode & quick-item billing",
      "Live stock across outlets",
      "One-click GST reports",
      "Loyalty that brings buyers back",
  ...
  },
  {
    ...
    category: "SaaS & ERP",
    about:
      "The operating system for automobile dealerships and wrap studios — every vehicle tracked from first enquiry to final invoice, with profit visible per job, not per quarter.",
    features: [
      "Enquiry-to-invoice tracking",
      "Job scheduling & floor view",
      "Inventory & parts control",
      "Per-job profit analytics",
  ...
  },
  {
    ...
    category: "Education",
    about:
      "A smart Digital SAT prep platform that adapts to each student — practice targets weak areas first, and clear dashboards show exactly what is improving before test day.",
    features: [
  ...
  },
  {
    ...
    category: "E-commerce",
    about:
      "The Indian online store of the global accessories brand — bags, jewellery and hair accessories for women and kids, browsed and bought in a few taps.",
    features: [
      "Fast catalogue & smart search",
      "Women & kids collections",
      "Offers, coupons & secure checkout",
      "Wishlist & easy reorders",
  ...
  },
  {
    ...
    category: "E-commerce",
    about:
      "Storefront for a Dhaka-based handcrafted jewellery and leather brand — sterling silver, gold and leather pieces, with personalisation built into the buying flow.",
    features: [
      "Handcrafted product catalogue",
      "Personalised & couple pieces",
      "Gift-finder collections",
      "bKash, Nagad & card payments",
      "Free-shipping & gifting flows",
      "Dhaka showroom pickup",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Quick order & enquiry flows",
      "Wishlist & product compare",
      "SSLCommerz secure payments",
      "Optimised for slow networks",
  ...
  },
  {
    ...
    about:
      "Australia's healthcare booking app — patients find nearby GPs, dentists and specialists, book in seconds and arrive with the paperwork already done.",
    features: [
      "Search by practice & specialty",
      "Real-time appointment booking",
      "Smart reminders & digital forms",
      "Telehealth consultations",
      "Family bookings in one account",
  ...
  },
  {
    ...
    category: "Health & Fitness",
    about:
      "The #1 yoga app since 2012, used by 60 million+ people — 2,000+ guided sessions from classic yoga to wall pilates, with a Smart Coach that builds personal 28-day plans.",
    features: [
      "2,000+ guided sessions",
      "Smart Coach 28-day plans",
  ...
  },
  {
    ...
    about:
      "The daily planner that puts calendar, tasks and notes on one screen — plan the day in one glance instead of three apps.",
    features: [
      "Day, week & month views",
      "Tasks with priorities & reminders",
      "Recurring events & alerts",
  ...
  },
  {
    ...
    category: "Kids Games",
    about:
      "An endless-runner kids love — dash through colourful 3D worlds, dodge obstacles and collect coins, then spend them decorating the cat's home room by room.",
    features: [
      "One-tap runner controls",
      "Coins, boosts & power-ups",
  ...
  },
  {
    ...
    category: "Social",
    about:
      "A location-based dating app serving a global audience — profile discovery, matching and real-time chat, with verification and moderation tooling at the core.",
    features: [
      "Swipe discovery & matching",
      "Smart match filters",
  ...
  },
  {
    ...
    category: "AI Tools",
    about:
      "Speak instead of type: Superflow turns natural speech into clean, formatted text in any app — notes, emails and messages dictated at the speed of thought.",
    features: [
