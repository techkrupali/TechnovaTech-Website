    ...
    <div className="pt-32 pb-16 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-4xl">
          ...
          <p className="text-muted-foreground mb-6">Email: hello.technovatechnologies@gmail.com<br/>Phone: +91 93167 34210<br/>Head Office: R.K. World Tower, Rajkot, Gujarat, India<br/>Ahmedabad Branch: Titanium City Center Business Park, Ahmedabad, Gujarat 380015</p>
          ...
          <p className="text-muted-foreground">Technova Tech<br/>Email: hello.technovatechnologies@gmail.com<br/>Phone: +91 93167 34210<br/>Head Office: R.K. World Tower, Rajkot, Gujarat, India<br/>Ahmedabad Branch: Titanium City Center Business Park, Ahmedabad, Gujarat 380015</p>
        </div>
      </div>
    </div>
  )
