...
export const metadata: Metadata = {
  title: "Drive Automatic — Automatic Driving Lessons in Brighton | Preview by Technova Tech",
    ...
    <main className="min-h-screen bg-white text-[#12131a] antialiased">
      ...
      <div className="bg-[#12131a] text-white text-center text-[11px] sm:text-xs px-4 py-2.5">
        ...
        <span className="text-white/75">
          — built by Technova Tech for Drive Automatic. Every detail here is real, from your own listings. Like it?
