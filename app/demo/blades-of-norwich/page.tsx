...
export const metadata: Metadata = {
  title: "Blades of Norwich — Barbershop on Pottergate | Preview by Technova Tech",
    ...
    <main className="min-h-screen bg-[#0c0c0e] text-[#f5f1e8] antialiased">
      ...
      <div className="bg-[#151519] text-center text-[11px] sm:text-xs px-4 py-2.5 border-b border-white/5">
        ...
        <span className="text-white/70">
          — built by Technova Tech for Blades of Norwich. Every price, name &amp; detail here is real, pulled from your
