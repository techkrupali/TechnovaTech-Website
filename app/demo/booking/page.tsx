...
export const metadata: Metadata = {
  title: "Northside Auto Spa — Demo Booking Site | Technova Tech",
  description:
    "Live demo of a Technova Tech one-page booking micro-site: services, prices, reviews and one-tap booking — live in 48 hours for $299.",
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 pb-24">
      ...
      <div className="bg-slate-900 text-white text-center text-xs sm:text-sm px-4 py-2.5">
        ...
        — a Technova Tech one-page booking site. Yours: live in 48 hours, $299 one-time.{" "}
      ...
      <footer className="max-w-3xl mx-auto px-5 pb-12 text-center">
        <div className="rounded-2xl border-2 border-dashed border-slate-300 p-6">
          <p className="text-sm text-slate-600 mb-3">
            ...
            Built by <strong>Technova Tech</strong> (Kelowna BC · Rajkot IN) — live in 48 hours, <strong>$299 one-time</strong>, no monthly fees.
          </p>
          <Link
            href="/contact"
