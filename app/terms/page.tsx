    ...
    <div className="pt-32 pb-16 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-4xl">
          ...
          <p className="text-muted-foreground mb-6">By accessing Technova Tech services, you agree to be bound by these terms, Indian laws including Information Technology Act 2000, Consumer Protection Act 2019, and Gujarat state regulations.</p>
          
          <h2 className="text-2xl font-semibold mb-4 text-foreground">2. Company Information</h2>
          <p className="text-muted-foreground mb-6">Technova Tech is a technology company registered in Gujarat, India, providing SaaS solutions (Retailians POS, 911 Wrap ERP, DSAT Guru) in compliance with Indian business regulations.</p>
          ...
          <p className="text-muted-foreground mb-6">Name: Grievance Officer<br/>Email: hello.technovatechnologies@gmail.com<br/>Phone: +91 93167 34210<br/>Response time: 72 hours</p>
          
          <h2 className="text-2xl font-semibold mb-4 text-foreground">14. Contact Information</h2>
          <p className="text-muted-foreground">Technova Tech<br/>Email: hello.technovatechnologies@gmail.com<br/>Phone: +91 93167 34210<br/>Head Office: R.K. World Tower, Rajkot, Gujarat, India<br/>Ahmedabad Branch: Titanium City Center Business Park, Ahmedabad, Gujarat 380015<br/>Business Hours: 9 AM - 6 PM IST</p>
        </div>
      </div>
    </div>
  )
